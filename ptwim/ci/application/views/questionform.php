			...
			<section class="content">
				<div class="row">
					...
					<div class="box box-primary">
						...
						<!-- /.box-header -->
						<!-- form start -->
						<form role="form" action="createform" method="POST">
							<div class="box-body">
								...
								<div class="control-group text-center"><br>
									<button class="btn btn-success" type="submit" name="ok">Enregistrer cette réponse</button>
									<button class="btn btn-warning" type="submit" name="quitter">Créer et Quitter le formulaire</button>
								</div>
							</div>
						</form>
						<!-- Copy Fields -->
